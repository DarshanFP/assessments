...
// require_once __DIR__ . '/../../includes/role_based_sidebar.php';
...
try {
    // Fetch active projects assigned to the logged-in user with Total Expensed and Available Funds, including start_date, end_date, organization, funding details, and multiple Project In-Charges
    $stmt = $pdo->prepare("
        ...
        INNER JOIN ProjectAssignments pa ON p.project_id = pa.project_id AND pa.is_active = 1
        LEFT JOIN ssmntUsers u ON pa.project_incharge_id = u.id
        WHERE pa.project_incharge_id = :user_id AND p.is_active = 1
        GROUP BY p.project_id, p.project_name, p.total_budget, p.start_date, p.end_date, p.funding_source, p.fund_type, o.organization_id, o.organization_code, o.organization_name, o.color_theme, pa.is_primary
...
<head>
    ...
    <title>My Projects Budget Overview</title>
        ...
        <div class="main-content">
            ...
            <div class="content-container">
                ...
                <div class="page-header">
                    <h1>My Projects Budget Overview</h1>
                </div>
                ...
                <div class="enhanced-table">
                    ...
                    <?php else: ?>
                        <div class="text-center py-8">
                            <div class="text-gray-500 text-lg mb-2">No projects found assigned to you.</div>
                            <div class="text-gray-400 text-sm">Projects will appear here once they are assigned to you by a Councillor.</div>
                        </div>
                    <?php endif; ?>
                </div>
